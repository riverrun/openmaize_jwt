defmodule OpenmaizeJWT.Config do
  ...
  like the following example.
      ...
      config :openmaize_jwt,
        signing_salt: "some random string"
        token_alg: :sha256,
        token_validity: 60,
  ...
  @doc """
  The salt used when generating the JSON Web Token signing key.

  This can be generated by the OpenmaizeJWT.Tools.gen_salt/1 function.
  """
  def signing_salt do
    Application.get_env(:openmaize_jwt, :signing_salt)
  end
end
